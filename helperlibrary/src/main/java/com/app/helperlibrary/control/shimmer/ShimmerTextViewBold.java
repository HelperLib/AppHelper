...
public class ShimmerTextViewBold extends AppCompatTextView implements ShimmerViewBase {

    private ShimmerViewHelper shimmerViewHelper;

    public ShimmerTextViewBold(Context context) {
        super(context);
        init();
    ...
    public ShimmerTextViewBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    ...
    public ShimmerTextViewBold(Context context, AttributeSet attrs, int defStyle) {
